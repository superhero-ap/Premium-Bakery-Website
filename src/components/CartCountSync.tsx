...
const readOrders = (): SavedOrder[] => {
  try { return JSON.parse(localStorage.getItem('bakery-orders') || '[]') as SavedOrder[] } catch { return [] }
}
